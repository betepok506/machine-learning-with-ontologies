...
print(f"Команда запуска: {cmdcorpus}")
os.system(cmdcorpus)
print ("\n  ######################################################################\n")
...
cmdwv="python onto2vec/runWV_onto.py "+str(ontology_corpus.name)+" "+str(window)+" "+str(embedding)+" "+str(mincoun)+" "+str(model)+" "+str(entities_file)+" "+ str(tempvecs.name)
print(f"Команда запуска: {cmdwv}")
os.system(cmdwv)
...
print(f"Команда запуска: {cmdproc}")
os.system (cmdproc)
